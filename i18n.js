...
const TRANSLATIONS = {
  ...
  "tab.prestataires":   "Prestataires",
    ...
    "emp.photo":          "Photos (obligatoire)",
    "emp.photo.required": "Au moins une photo est obligatoire pour envoyer la demande.",
  ...
  "mgr.ask.info.sent":  "Demande d'information envoyée à l'employé.",
    ...
    "users.password.set":      "Définir un mot de passe",
    "users.password.change":   "Changer le mot de passe",
    "users.password.is.defined":"Mot de passe défini",
    ...
    "plan.ext.task.new":            "Nouvelle tâche partenaire",
    "plan.ext.task.edit":           "Modifier la tâche partenaire",
    "plan.ext.task.partner.none":   "— Choisir un partenaire —",
  ...
  nl: {
    ...
    "emp.photo":          "Foto's (verplicht)",
    "emp.photo.required": "Minstens één foto is verplicht om de aanvraag te versturen.",
  ...
  "mgr.ask.info.sent":  "Informatieverzoek naar medewerker verstuurd.",
    ...
    "users.password.is.defined":"Wachtwoord ingesteld",
    ...
    "plan.ext.task.new":            "Nieuwe partnertaak",
    "plan.ext.task.edit":           "Partnertaak bewerken",
    "plan.ext.task.partner.none":   "— Kies een partner —",
